...
This code is an adaptation of [Martin Ganahl's code](https://github.com/mganahl/Recurrent_NN_VMC). We optimized the code and fixed some bugs and added the complex RNN and the 2D RNN implementations.
