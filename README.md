...
- **J1J2**: 1D Complex Recurrent Neural Network Wavefunction for 1D J1-J2 Model. If you want to apply an initial Marshall sign: Go to file "Training_J1J2.py", and change **Marshall_sign** argument in the function "J1J2MatrixElements" to **True**
